...
public:
    ColorDetector() : Node("configurable_color_filter") {
        ...
        this->declare_parameter("output_class_name", "green");
        this->declare_parameter("min_area", 75);
        this->declare_parameter("lower_hsv_list", std::vector<int64_t>{35, 50, 50}); // Default for red
        this->declare_parameter("upper_hsv_list", std::vector<int64_t>{85, 255, 255});
