...
#ifndef COMP_TASKS_INTERFACES__MSG__DETAIL__TASK__FUNCTIONS_H_
#define COMP_TASKS_INTERFACES__MSG__DETAIL__TASK__FUNCTIONS_H_
 ...
 * calls
 * comp_tasks_interfaces__msg__Task__init().
...
/**
 * It calls
 * comp_tasks_interfaces__msg__Task__fini()
 ...
 * comp_tasks_interfaces__msg__Task__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * comp_tasks_interfaces__msg__Task__Sequence__fini()
 * on the array,
...
#endif  // COMP_TASKS_INTERFACES__MSG__DETAIL__TASK__FUNCTIONS_H_
