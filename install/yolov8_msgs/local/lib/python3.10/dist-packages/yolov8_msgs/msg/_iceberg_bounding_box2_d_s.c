...
bool yolov8_msgs__msg__iceberg_bounding_box2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yolov8_msgs.msg._iceberg_bounding_box2_d.IcebergBoundingBox2D", full_classname_dest, 61) == 0);
  }
  yolov8_msgs__msg__IcebergBoundingBox2D * ros_message = _ros_message;
  {  // xmin
...
{
  /* NOTE(esteve): Call constructor of IcebergBoundingBox2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yolov8_msgs.msg._iceberg_bounding_box2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IcebergBoundingBox2D");
