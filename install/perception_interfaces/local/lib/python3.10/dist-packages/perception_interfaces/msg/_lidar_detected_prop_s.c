...
bool perception_interfaces__msg__lidar_detected_prop__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("perception_interfaces.msg._lidar_detected_prop.LidarDetectedProp", full_classname_dest, 64) == 0);
  }
  perception_interfaces__msg__LidarDetectedProp * ros_message = _ros_message;
  {  // label
  ...
  {  // radius_diff
    PyObject * field = PyObject_GetAttrString(_pymsg, "radius_diff");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->radius_diff = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of LidarDetectedProp */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_interfaces.msg._lidar_detected_prop");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LidarDetectedProp");
  ...
  {  // radius_diff
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->radius_diff);
    {
      int rc = PyObject_SetAttrString(_pymessage, "radius_diff", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
