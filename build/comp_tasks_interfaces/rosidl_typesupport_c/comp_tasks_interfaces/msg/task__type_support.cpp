...
static const _Task_type_support_symbol_names_t _Task_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, comp_tasks_interfaces, msg, Task)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, comp_tasks_interfaces, msg, Task)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, comp_tasks_interfaces, msg, Task)() {
  return &::comp_tasks_interfaces::msg::rosidl_typesupport_c::Task_message_type_support_handle;
}
