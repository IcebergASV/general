...
bool comp_tasks_interfaces__msg__simplified_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("comp_tasks_interfaces.msg._simplified_detection.SimplifiedDetection", full_classname_dest, 67) == 0);
  }
  comp_tasks_interfaces__msg__SimplifiedDetection * ros_message = _ros_message;
  {  // class_name
...
{
  /* NOTE(esteve): Call constructor of SimplifiedDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("comp_tasks_interfaces.msg._simplified_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SimplifiedDetection");
