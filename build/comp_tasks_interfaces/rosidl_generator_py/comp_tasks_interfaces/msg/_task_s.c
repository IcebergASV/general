...
bool comp_tasks_interfaces__msg__task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("comp_tasks_interfaces.msg._task.Task", full_classname_dest, 36) == 0);
  }
  comp_tasks_interfaces__msg__Task * ros_message = _ros_message;
  {  // current_task
    ...
    ros_message->current_task = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * comp_tasks_interfaces__msg__task__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("comp_tasks_interfaces.msg._task");
  ...
  {  // current_task
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->current_task);
    {
