...
bool perception_interfaces__msg__bounding_box__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("perception_interfaces.msg._bounding_box.BoundingBox", full_classname_dest, 51) == 0);
  }
  perception_interfaces__msg__BoundingBox * ros_message = _ros_message;
  {  // xmin
...
PyObject * perception_interfaces__msg__bounding_box__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_interfaces.msg._bounding_box");
