...
bool perception_interfaces__msg__prop__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("perception_interfaces.msg._prop.Prop", full_classname_dest, 36) == 0);
  }
  perception_interfaces__msg__Prop * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of Prop */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("perception_interfaces.msg._prop");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Prop");
