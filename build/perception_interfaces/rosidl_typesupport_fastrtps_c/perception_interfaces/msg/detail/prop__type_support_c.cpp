...
#include "perception_interfaces/msg/detail/prop__rosidl_typesupport_fastrtps_c.h"
...
using _Prop__ros_msg_type = perception_interfaces__msg__Prop;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Prop__ros_msg_type * ros_message = static_cast<const _Prop__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Prop__ros_msg_type * ros_message = static_cast<_Prop__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _Prop__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_perception_interfaces__msg__Prop(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = perception_interfaces__msg__Prop;
    is_plain =
      (
...
static size_t _Prop__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_perception_interfaces__msg__Prop(
...
static message_type_support_callbacks_t __callbacks_Prop = {
...
static rosidl_message_type_support_t _Prop__type_support = {
