...
#include "perception_interfaces/msg/detail/lidar_detected_prop__rosidl_typesupport_fastrtps_c.h"
...
using _LidarDetectedProp__ros_msg_type = perception_interfaces__msg__LidarDetectedProp;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LidarDetectedProp__ros_msg_type * ros_message = static_cast<const _LidarDetectedProp__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LidarDetectedProp__ros_msg_type * ros_message = static_cast<_LidarDetectedProp__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _LidarDetectedProp__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_perception_interfaces__msg__LidarDetectedProp(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = perception_interfaces__msg__LidarDetectedProp;
    is_plain =
      (
...
static size_t _LidarDetectedProp__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_perception_interfaces__msg__LidarDetectedProp(
...
static message_type_support_callbacks_t __callbacks_LidarDetectedProp = {
...
static rosidl_message_type_support_t _LidarDetectedProp__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LidarDetectedProp,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, perception_interfaces, msg, LidarDetectedProp)() {
  return &_LidarDetectedProp__type_support;
}
