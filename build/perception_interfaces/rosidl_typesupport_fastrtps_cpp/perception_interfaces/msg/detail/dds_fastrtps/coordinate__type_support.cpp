...
#include "perception_interfaces/msg/detail/coordinate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const perception_interfaces::msg::Coordinate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  perception_interfaces::msg::Coordinate & ros_message)
{
  // Member: xmin
  cdr >> ros_message.xmin;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = perception_interfaces::msg::Coordinate;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const perception_interfaces::msg::Coordinate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<perception_interfaces::msg::Coordinate *>(
    untyped_ros_message);
...
{
  return &perception_interfaces::msg::typesupport_fastrtps_cpp::_Coordinate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_interfaces, msg, Coordinate)() {
  return &perception_interfaces::msg::typesupport_fastrtps_cpp::_Coordinate__handle;
}
