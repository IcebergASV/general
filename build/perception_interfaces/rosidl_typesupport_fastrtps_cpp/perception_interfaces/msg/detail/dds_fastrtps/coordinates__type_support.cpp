...
#include "perception_interfaces/msg/detail/coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const perception_interfaces::msg::Coordinates &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  perception_interfaces::msg::Coordinates &);
...
cdr_serialize(
  const perception_interfaces::msg::Coordinates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  perception_interfaces::msg::Coordinates & ros_message)
{
  // Member: coordinates
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: coordinates
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        perception_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Coordinates(
  ...
  if (is_plain) {
    ...
    using DataType = perception_interfaces::msg::Coordinates;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const perception_interfaces::msg::Coordinates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<perception_interfaces::msg::Coordinates *>(
    untyped_ros_message);
...
{
  return &perception_interfaces::msg::typesupport_fastrtps_cpp::_Coordinates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perception_interfaces, msg, Coordinates)() {
  return &perception_interfaces::msg::typesupport_fastrtps_cpp::_Coordinates__handle;
}
