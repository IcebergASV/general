...
static const _SegmentArray_type_support_symbol_names_t _SegmentArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, slg_msgs, msg, SegmentArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, slg_msgs, msg, SegmentArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, slg_msgs, msg, SegmentArray)() {
  return &::slg_msgs::msg::rosidl_typesupport_c::SegmentArray_message_type_support_handle;
}
