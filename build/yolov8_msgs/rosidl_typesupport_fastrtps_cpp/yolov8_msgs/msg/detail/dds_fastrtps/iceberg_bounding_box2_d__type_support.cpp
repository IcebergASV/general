...
#include "yolov8_msgs/msg/detail/iceberg_bounding_box2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolov8_msgs::msg::IcebergBoundingBox2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov8_msgs::msg::IcebergBoundingBox2D & ros_message)
{
  // Member: xmin
  cdr >> ros_message.xmin;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_msgs::msg::IcebergBoundingBox2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yolov8_msgs::msg::IcebergBoundingBox2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov8_msgs::msg::IcebergBoundingBox2D *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IcebergBoundingBox2D__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yolov8_msgs::msg::IcebergBoundingBox2D *>(
...
static size_t _IcebergBoundingBox2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IcebergBoundingBox2D(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _IcebergBoundingBox2D__callbacks = {
  "yolov8_msgs::msg",
...
static rosidl_message_type_support_t _IcebergBoundingBox2D__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IcebergBoundingBox2D__callbacks,
...
{
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_IcebergBoundingBox2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_msgs, msg, IcebergBoundingBox2D)() {
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_IcebergBoundingBox2D__handle;
}
