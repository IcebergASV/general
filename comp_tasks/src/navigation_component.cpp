...
namespace comp_tasks
{
  ...
  {
    example_sub_ = this->create_subscription<std_msgs::msg::Int32>("/comp_tasks/subscribing_topic", 10, std::bind(&navigation::callback, this, _1));
...
RCLCPP_COMPONENTS_REGISTER_NODE(comp_tasks::navigation)
