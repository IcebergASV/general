...
namespace comp_tasks
{
  ...
  : Node(node_name, options)
  {
    ...
    task_to_execute_sub_ = this->create_subscription<comp_tasks_interfaces::msg::StartTask>("/comp_tasks/task_to_execute", 10, std::bind(&Maneuvering::taskToExecuteCallback, this, _1));
    ...
    local_wp_pub_ = this->create_publisher<geometry_msgs::msg::PoseStamped>("mavros/setpoint_position/local", 10);
    status_logger_pub_ = this->create_publisher<std_msgs::msg::String>("/comp_tasks/maneuvering/status", 10);
    ...
    Maneuvering::getStringParam("bbox_selection", p_bbox_selection_, "LARGEST", "Selectes either largest or innermost bounding boxes");
  ...
  void Maneuvering::taskToExecuteCallback(const comp_tasks_interfaces::msg::StartTask::SharedPtr msg)
  {
