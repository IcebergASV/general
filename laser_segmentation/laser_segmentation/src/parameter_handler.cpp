...
//using nav2_util::ParameterHandler::declare_parameter_if_not_declared;
  ...
  const rclcpp::Logger & logger)
{
  ...
  if (!node->has_parameter("min_points_segment")) {
    node->declare_parameter("min_points_segment", rclcpp::ParameterValue(3), rcl_interfaces::msg::ParameterDescriptor()
    ...
    if (!node->has_parameter("max_points_segment")) {
      node->declare_parameter("max_points_segment", rclcpp::ParameterValue(200), rcl_interfaces::msg::ParameterDescriptor()
   ...
   if (!node->has_parameter("min_avg_distance_from_sensor")) {
    node->declare_parameter("min_avg_distance_from_sensor", rclcpp::ParameterValue(0.0),
...
if (!node->has_parameter("max_avg_distance_from_sensor")) {
    node->declare_parameter("max_avg_distance_from_sensor", rclcpp::ParameterValue(20.0),
        rcl_interfaces::msg::ParameterDescriptor()
...
if (!node->has_parameter("min_segment_width")) {
    node->declare_parameter("min_segment_width", rclcpp::ParameterValue(0.20),
        rcl_interfaces::msg::ParameterDescriptor()
...
if (!node->has_parameter("max_segment_width")) {
...
if (!node->has_parameter("distance_threshold")) {
    node->declare_parameter("distance_threshold", rclcpp::ParameterValue(0.30),
        rcl_interfaces::msg::ParameterDescriptor()
        .set__description(
...
if (!node->has_parameter("noise_reduction")) {
    node->declare_parameter("noise_reduction", rclcpp::ParameterValue(0.30),
        rcl_interfaces::msg::ParameterDescriptor()
...
if (!node->has_parameter("method_threshold")) {
    node->declare_parameter("method_threshold", rclcpp::ParameterValue(""),
        rcl_interfaces::msg::ParameterDescriptor()
        .set__description(
...
if (!node->has_parameter("scan_topic")) {
    node->declare_parameter("scan_topic", rclcpp::ParameterValue("scan"),
        rcl_interfaces::msg::ParameterDescriptor()
        .set__description("Laser topic to read"));
}

if (!node->has_parameter("segments_topic")) {
    node->declare_parameter("segments_topic", rclcpp::ParameterValue("segments"),
        rcl_interfaces::msg::ParameterDescriptor()
        .set__description("published Segements topic"));
}

if (!node->has_parameter("segmentation_type")) {
