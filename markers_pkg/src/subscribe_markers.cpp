...
public:
    ...
    : Node("prop_subscriber")
    {
        ...
        // subscription2_ = this->create_subscription<markers_pkg::msg::Waypoint>("waypoint", 10, std::bind(&PropSubscriber::waypoint_callback, this, _1));
...
private:
    ...
    // std::shared_ptr<rclcpp::Subscription<markers_pkg::msg::Waypoint>> subscription2_;
