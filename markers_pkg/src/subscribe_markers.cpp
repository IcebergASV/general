...
public:
    ...
    : Node("prop_subscriber")
    {
        ...
        // subscription2_ = this->create_subscription<markers_pkg_interfaces::msg::Waypoint>("waypoint", 10, std::bind(&PropSubscriber::waypoint_callback, this, _1));
...
private:
    ...
    {
        auto publisher = this->create_publisher<visualization_msgs::msg::Marker>("robotTrail", 10);
        auto publisher2 = this->create_publisher<visualization_msgs::msg::Marker>("robotPosition", 10);
        ...
        robot.mesh_resource = "file:///home/icebergasv/Desktop/IcebergASV/ros2_ws/src/markers_pkg/models/boat-assembly-simple.STL";
    ...
    // std::shared_ptr<rclcpp::Subscription<markers_pkg_interfaces::msg::Waypoint>> subscription2_;
