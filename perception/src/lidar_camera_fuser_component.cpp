...
namespace perception
{
  ...
  {
    sub_ = this->create_subscription<slg_msgs::msg::SegmentArray>("segments", 10, std::bind(&LidarCameraFuser::laserSegmentCallback, this, _1));
    pub_ = this->create_publisher<perception_interfaces::msg::LidarDetectedPropArray>("perception/lidar_detected_props", 10);

    LidarCameraFuser::getParam<double>("max_lidar_dist", p_max_lidar_dist_, 0.0, "Maximum accepted range of lidar readings in m");
    LidarCameraFuser::getParam<double>("min_lidar_dist", p_min_lidar_dist_, 0.0, "Minimum accepted range of lidar readings in m");
    LidarCameraFuser::getParam<int>("min_points_in_segment", p_min_points_in_segment_, 0, "Minimum accepted points in a laser_segment");
    LidarCameraFuser::getParam<double>("max_radius_diff", p_max_radius_diff_, 0.0, "Maximum difference between measured and expected prop radii to consider a laser_segment a prop, in m");
    LidarCameraFuser::getStringParamConvertToMap<double>("props_radii", p_prop_radii_, "{}", "List of prop radii in m");
    LidarCameraFuser::getParam<double>("lidar_fov", p_lidar_fov_, 0.0, "Lidar fov in degrees");
  ...
  void LidarCameraFuser::laserSegmentCallback(const slg_msgs::msg::SegmentArray::SharedPtr msg)
  {
  ...
  void LidarCameraFuser::attemptToCreateAndAddLidarDetectedProp(std::vector<geometry_msgs::msg::Point> points, perception_interfaces::msg::LidarDetectedPropArray& lidar_detected_prop_array)
  {
  ...
  perception_interfaces::msg::LidarDetectedProp LidarCameraFuser::createLidarDetectedProp(std::vector<geometry_msgs::msg::Point> points)
  {
  ...
  bool LidarCameraFuser::measuredRadiusIsCloseToExpected(double radius_diff)
  {
    return radius_diff < p_max_radius_diff_;
  }
  
  void LidarCameraFuser::findClosestMatchAndSetRadiusDiff(perception_interfaces::msg::LidarDetectedProp& prop)
  {
